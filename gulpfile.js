...
const paths = {
  ...
  images: {
    src: sourceFolder + '/img/**/*.{png,jpg,jpeg,svg,gif,ico,webp}',
    dist: distFolder + '/img/',
    watch: sourceFolder + '/img/**/*.{png,jpg,jpeg,svg,gif,ico,webp}',
  },
  fonts: {
    src: [sourceFolder + '/fonts/**/*.ttf', sourceFolder + '/fonts/**/*.woff'],
...
// run command - gulp fonts
function fontsAllCopy() {
...
let build = gulp.series(
  cleanimg,
  gulp.parallel(html, scripts, styles, images, fontsAllCopy),
  fontsAllCopy,
  fontsStyle
);
...
exports.fonts = fonts;
exports.fontsAllCopy = fontsAllCopy;
